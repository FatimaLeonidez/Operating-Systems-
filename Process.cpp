//Edited to suit the needs of the merge task.
#include "Process.h"
//#include "Process_main.cpp"
#include <iostream>


Process::Process(int pid, int arrival_time, int burst_time, int priority) : pid(pid), arrival_time(arrival_time), burst_time(burst_time), priority(priority),
remaining_time(burst_time), waiting_time(0), turnaround_time(0), state(ProcessState::NEW) {} //Added priority.
