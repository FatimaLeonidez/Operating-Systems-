// This file contains the main component, the heart, of our OS program. This is the part that must be run in order to experience the program properly.
#include "Process.h"
#include "FCFS.h"
#include "Auth.h"
#include "page.h"
    ...
    while (true) { //This segment of code will loop until certain conditions are met.
        ...
        if (choice1 == "sign up") { //The "sign up" choice
            ...
            cout << "Process 4 (PID: 4 | Arrival Time: 0 | Burst Time: 5 | Priority: 3)\n\n" << endl;
                ...
                // FCFS Scheduling Sim by Fatima L.
                ...
                // SJF Scheduling Sim by Cecilia D.
                ...
                // Priority Scheduling Sim by Alejandra R.
                ...
                //Beginning of Virtual Memory segment
