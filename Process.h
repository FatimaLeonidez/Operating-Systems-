...
public:
    ...
    int get_burst_time(); // retrieves the CPU's burst time
    int get_remaining_time(); // retrieves remaining time to decrement

    int get_waiting_time(); // calculates and retrieves waiting time
