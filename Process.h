...
public:
    Process(int pid, int arrival_time, int burst_time, int priority); // constructor for process: its 3 params identify its attributes. Added priority.
    ...
    void time_calculations(int time_of_completion);
